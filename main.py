...
def whrite(phrase):
  ...
  print('--Resultados--')
  print('Has tardado: ', int(elapsed_time), 'segundos')
  print('Has escrito ',  correct_count, 'palabras bien y ', int(incorrect_count)-3, 'palabras mal')
...
print('         ,_  o_|_ o        _,      ,       _  _  _|      _|_  _  , _|_ \n|  |  |_/  | | |  | /|/|  / |     / \_|/\_|/ |/ / |       |  |/ / \_|  \n \/ \/     |/|/|_/|/ | |_/\/|/     \/ |_/ |_/|_/\/|_/     |_/|_/ \/ |_/\n                           (|        (|                                ')
print('Welcome!')
phrase = MAIN()
print(phrase)
print('----')
